...
* "Расширения Markdown": настройка функций, поддерживаемых `markdown-it-py` (таблицы, списки задач, сноски, идентификаторы заголовков и т. п.).
* "Путь": здесь вы можете задать место сохранения по умолчанию на жестком диске для преобразованных документов. Это удобно, если вы всегда используете одну и ту же папку для хранения всех своих работ.
